...
class Bird:
    IMGS = BIRD_IMGS
    MAX_ROTATION = 25 
    ROT_VEL = 20 #fordulas sebesseg
    ANIMATION_TIME = 5
    
    def __init__(self, x, y):
        self.x = x
        self.y = y
        self.tilt = 0 #tick = billenes
        self.tick_count = 0
        self.vel = 0 #velocity = sebesseg
        self.height = self.y
        self.img_count = 0
    ...
    def move(self):
        ...
        d = self.vel*self.tick_count + 1.5*self.tick_count**2 #mennyi pixelt megyunk le/fel ezen a ticken
